...
DETA_SQLITE_DB_DRIVE = 'sqlite.db'

DETA_SQLITE_DB_FILE = DATABASES['default']['NAME']
DETA_SQLITE_DB_LOCAL_FILE = DETA_SQLITE_DB_FILE

if os.getenv('DETA_RUNTIME'):
    DETA_SQLITE_DB_LOCAL_FILE = "/tmp/" + DETA_SQLITE_DB_FILE
